...
mainv1.12.1v1.11.0v1.10.1v1.9.1v1.7.1v1.6.0v1.5.0v1.4.0v1.3.7v1.2.4v1.1.7v1.0.0.rc7v0.36.2v0.35.3v0.34.6v0.33.5v0.32.6v0.31.4v0.30.2v0.29.3v0.28.1v0.27.1v0.26.5v0.25.2v0.24.7v0.23.5v0.22.2v0.21.4v0.20.3v0.19.3v0.18.0.rc0v0.17.3v0.16.3v0.15.1v0.14.1v0.13.4v0.12.1v0.11.0v0.10.1v0.9.1v0.8.1v0.7.0.rc0v0.6.0.rc0v0.5.1CNDEENFRHIKOTM

[3,610](https://github.com/huggingface/huggingface_hub)

Get started

[Home](https://huggingface.co/docs/huggingface_hub/index) [Quickstart](https://huggingface.co/docs/huggingface_hub/quick-start) [Installation](https://huggingface.co/docs/huggingface_hub/installation)

How-to guides

[Overview](https://huggingface.co/docs/huggingface_hub/guides/overview) [Download files](https://huggingface.co/docs/huggingface_hub/guides/download) [Upload files](https://huggingface.co/docs/huggingface_hub/guides/upload) [Buckets](https://huggingface.co/docs/huggingface_hub/guides/buckets) [Use the CLI](https://huggingface.co/docs/huggingface_hub/guides/cli) [Create a CLI extension](https://huggingface.co/docs/huggingface_hub/guides/cli-extensions) [HfFileSystem](https://huggingface.co/docs/huggingface_hub/guides/hf_file_system) [Repository](https://huggingface.co/docs/huggingface_hub/guides/repository) [Search](https://huggingface.co/docs/huggingface_hub/guides/search) [Inference](https://huggingface.co/docs/huggingface_hub/guides/inference) [Inference Endpoints](https://huggingface.co/docs/huggingface_hub/guides/inference_endpoints) [Jobs](https://huggingface.co/docs/huggingface_hub/guides/jobs) [Community Tab](https://huggingface.co/docs/huggingface_hub/guides/community) [Collections](https://huggingface.co/docs/huggingface_hub/guides/collections) [Cache](https://huggingface.co/docs/huggingface_hub/guides/manage-cache) [Model Cards](https://huggingface.co/docs/huggingface_hub/guides/model-cards) [Manage your Space](https://huggingface.co/docs/huggingface_hub/guides/manage-spaces) [Integrate a library](https://huggingface.co/docs/huggingface_hub/guides/integrations) [Webhooks](https://huggingface.co/docs/huggingface_hub/guides/webhooks)

Conceptual guides

[Git vs HTTP paradigm](https://huggingface.co/docs/huggingface_hub/concepts/git_vs_http) [Migrating to huggingface\_hub v1.0](https://huggingface.co/docs/huggingface_hub/concepts/migration)

Reference

[Overview](https://huggingface.co/docs/huggingface_hub/package_reference/overview) [Authentication](https://huggingface.co/docs/huggingface_hub/package_reference/authentication) [Environment variables](https://huggingface.co/docs/huggingface_hub/package_reference/environment_variables) [Hugging Face Hub API](https://huggingface.co/docs/huggingface_hub/package_reference/hf_api) [CLI](https://huggingface.co/docs/huggingface_hub/package_reference/cli) [Downloading files](https://huggingface.co/docs/huggingface_hub/package_reference/file_download) [Mixins & serialization methods](https://huggingface.co/docs/huggingface_hub/package_reference/mixins) [Inference Types](https://huggingface.co/docs/huggingface_hub/package_reference/inference_types) [Inference Client](https://huggingface.co/docs/huggingface_hub/package_reference/inference_client) [Inference Endpoints](https://huggingface.co/docs/huggingface_hub/package_reference/inference_endpoints) [MCP Client](https://huggingface.co/docs/huggingface_hub/package_reference/mcp) [HfFileSystem](https://huggingface.co/docs/huggingface_hub/package_reference/hf_file_system) [Utilities](https://huggingface.co/docs/huggingface_hub/package_reference/utilities) [Discussions and Pull Requests](https://huggingface.co/docs/huggingface_hub/package_reference/community) [Cache-system reference](https://huggingface.co/docs/huggingface_hub/package_reference/cache) [Repo Cards and Repo Card Data](https://huggingface.co/docs/huggingface_hub/package_reference/cards) [Space runtime](https://huggingface.co/docs/huggingface_hub/package_reference/space_runtime) [Collections](https://huggingface.co/docs/huggingface_hub/package_reference/collections) [TensorBoard logger](https://huggingface.co/docs/huggingface_hub/package_reference/tensorboard) [Webhooks server](https://huggingface.co/docs/huggingface_hub/package_reference/webhooks_server) [Serialization](https://huggingface.co/docs/huggingface_hub/package_reference/serialization) [Strict dataclasses](https://huggingface.co/docs/huggingface_hub/package_reference/dataclasses) [OAuth](https://huggingface.co/docs/huggingface_hub/package_reference/oauth) [Jobs](https://huggingface.co/docs/huggingface_hub/package_reference/jobs)
...
> For a complete reference of all commands and options, see the [CLI reference](https://huggingface.co/docs/huggingface_hub/package_reference/cli).
...
If the CLI is correctly installed, you should see a list of all the options available in the CLI. If you get an error message such as `command not found: hf`, please refer to the [Installation](https://huggingface.co/docs/huggingface_hub/installation) guide.
...
For more details about authentication, check out [this section](https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
...
This command will not log you out if you are logged in using the `HF_TOKEN` environment variable (see [reference](https://huggingface.co/docs/huggingface_hub/package_reference/environment_variables#hftoken)). If that is the case, you must unset the environment variable in your machine configuration.

## hf download

Use the `hf download` command to download files from the Hub directly. Internally, it uses the same [hf\_hub\_download()](https://huggingface.co/docs/huggingface_hub/v1.12.1/en/package_reference/file_download#huggingface_hub.hf_hub_download) and [snapshot\_download()](https://huggingface.co/docs/huggingface_hub/v1.12.1/en/package_reference/file_download#huggingface_hub.snapshot_download) helpers described in the [Download](https://huggingface.co/docs/huggingface_hub/guides/download) guide and prints the returned path to the terminal. In the examples below, we will walk through the most common use cases. For a full list of available options, you can run:
...
To download a single file from a repo, simply provide the repo\_id and filename as follows:
...
> For more details on how downloading to a local file works, check out the [download](https://huggingface.co/docs/huggingface_hub/guides/download#download-files-to-a-local-folder) guide.
...
For more details, check out the [download guide](https://huggingface.co/docs/huggingface_hub/guides/download#dry-run-mode).

### Specify cache directory

If not using `--local-dir`, all files will be downloaded by default to the cache directory defined by the `HF_HOME` [environment variable](https://huggingface.co/docs/huggingface_hub/package_reference/environment_variables#hfhome). You can specify a custom cache using `--cache-dir`:
...
For more details, check out the [environment variables reference](https://huggingface.co/docs/huggingface_hub/package_reference/environment_variables#hfhubdownloadtimeout). And rerun your download command.

## hf upload

Use the `hf upload` command to upload files to the Hub directly. Internally, it uses the same [upload\_file()](https://huggingface.co/docs/huggingface_hub/v1.12.1/en/package_reference/hf_api#huggingface_hub.HfApi.upload_file) and [upload\_folder()](https://huggingface.co/docs/huggingface_hub/v1.12.1/en/package_reference/hf_api#huggingface_hub.HfApi.upload_folder) helpers described in the [Upload](https://huggingface.co/docs/huggingface_hub/guides/upload) guide. In the examples below, we will walk through the most common use cases. For a full list of available options, you can run:
...
> `hf sync` is a convenient top-level alias for `hf buckets sync`. See the [Buckets guide](https://huggingface.co/docs/huggingface_hub/guides/buckets#sync-directories) for full details on all sync options.
...
The command supports several output formats for scripting: `--format json` prints structured objects, `--format csv` writes comma-separated rows, and `--quiet` prints only IDs. Use `--sort` to order entries by `accessed`, `modified`, `name`, or `size` (append `:asc` or `:desc` to control order), and `--limit` to restrict results to the top N entries. Combine these with `--cache-dir` to target alternative cache locations. See the [Manage your cache](https://huggingface.co/docs/huggingface_hub/guides/manage-cache) guide for advanced workflows.
...
As with the other cache commands, `--dry-run`, `--yes`, and `--cache-dir` are available. Refer to the [Manage your cache](https://huggingface.co/docs/huggingface_hub/guides/manage-cache) guide for more examples.
...
(updated in 07/2025 from Hugging Face [suggested\_hardware docs](https://huggingface.co/docs/hub/en/spaces-config-reference))

## Volumes

Mount a volume on the Job’s disk using `-v` or `--volume`.

You can mount any Hugging Face Repository (model/dataset/space) or [Storage Bucket](https://huggingface.co/docs/hub/storage-buckets) using the `hf://` URL scheme. For example:
...
[←Buckets](https://huggingface.co/docs/huggingface_hub/guides/buckets) [Create a CLI extension→](https://huggingface.co/docs/huggingface_hub/guides/cli-extensions)

[Command Line Interface (CLI)](https://huggingface.co/docs/huggingface_hub/guides/cli#command-line-interface-cli) [Getting started](https://huggingface.co/docs/huggingface_hub/guides/cli#getting-started) [Standalone installer (Recommended)](https://huggingface.co/docs/huggingface_hub/guides/cli#standalone-installer-recommended) [Using uv](https://huggingface.co/docs/huggingface_hub/guides/cli#using-uv) [Install with pip](https://huggingface.co/docs/huggingface_hub/guides/cli#install-with-pip) [Using Homebrew](https://huggingface.co/docs/huggingface_hub/guides/cli#using-homebrew) [hf auth login](https://huggingface.co/docs/huggingface_hub/guides/cli#hf-auth-login) [hf auth whoami](https://huggingface.co/docs/huggingface_hub/guides/cli#hf-auth-whoami) [hf auth logout](https://huggingface.co/docs/huggingface_hub/guides/cli#hf-auth-logout) [hf download](https://huggingface.co/docs/huggingface_hub/guides/cli#hf-download) [Download a single file](https://huggingface.co/docs/huggingface_hub/guides/cli#download-a-single-file) [Download an entire repository](https://huggingface.co/docs/huggingface_hub/guides/cli#download-an-entire-repository) [Download multiple files](https://huggingface.co/docs/huggingface_hub/guides/cli#download-multiple-files) [Download a dataset or a Space](https://huggingface.co/docs/huggingface_hub/guides/cli#download-a-dataset-or-a-space) [Download a specific revision](https://huggingface.co/docs/huggingface_hub/guides/cli#download-a-specific-revision) [Download to a local folder](https://huggingface.co/docs/huggingface_hub/guides/cli#download-to-a-local-folder) [Dry-run mode](https://huggingface.co/docs/huggingface_hub/guides/cli#dry-run-mode) [Specify cache directory](https://huggingface.co/docs/huggingface_hub/guides/cli#specify-cache-directory) [Specify a token](https://huggingface.co/docs/huggingface_hub/guides/cli#specify-a-token) [Quiet mode](https://huggingface.co/docs/huggingface_hub/guides/cli#quiet-mode) [Download timeout](https://huggingface.co/docs/huggingface_hub/guides/cli#download-timeout) [hf upload](https://huggingface.co/docs/huggingface_hub/guides/cli#hf-upload) [Upload an entire folder](https://huggingface.co/docs/huggingface_hub/guides/cli#upload-an-entire-folder) [Upload a single file](https://huggingface.co/docs/huggingface_hub/guides/cli#upload-a-single-file) [Upload multiple files](https://huggingface.co/docs/huggingface_hub/guides/cli#upload-multiple-files) [Upload to a dataset or Space](https://huggingface.co/docs/huggingface_hub/guides/cli#upload-to-a-dataset-or-space) [Upload to an organization](https://huggingface.co/docs/huggingface_hub/guides/cli#upload-to-an-organization) [Upload to a specific revision](https://huggingface.co/docs/huggingface_hub/guides/cli#upload-to-a-specific-revision) [Upload and create a PR](https://huggingface.co/docs/huggingface_hub/guides/cli#upload-and-create-a-pr) [Upload at regular intervals](https://huggingface.co/docs/huggingface_hub/guides/cli#upload-at-regular-intervals) [Specify a commit message](https://huggingface.co/docs/huggingface_hub/guides/cli#specify-a-commit-message) [Specify a token](https://huggingface.co/docs/huggingface_hub/guides/cli#specify-a-token) [Quiet mode](https://huggingface.co/docs/huggingface_hub/guides/cli#quiet-mode) [hf upload-large-folder](https://huggingface.co/docs/huggingface_hub/guides/cli#hf-upload-large-folder) [hf buckets](https://huggingface.co/docs/huggingface_hub/guides/cli#hf-buckets) [Create a bucket](https://huggingface.co/docs/huggingface_hub/guides/cli#create-a-bucket) [List and inspect buckets](https://huggingface.co/docs/huggingface_hub/guides/cli#list-and-inspect-buckets) [Delete a bucket](https://huggingface.co/docs/huggingface_hub/guides/cli#delete-a-bucket) [Remove files](https://huggingface.co/docs/huggingface_hub/guides/cli#remove-files) [Browse files](https://huggingface.co/docs/huggingface_hub/guides/cli#browse-files) [Copy files](https://huggingface.co/docs/huggingface_hub/guides/cli#copy-files) [Sync directories](https://huggingface.co/docs/huggingface_hub/guides/cli#sync-directories) [hf models](https://huggingface.co/docs/huggingface_hub/guides/cli#hf-models) [List models](https://huggingface.co/docs/huggingface_hub/guides/cli#list-models) [Get model info](https://huggingface.co/docs/huggingface_hub/guides/cli#get-model-info) [hf datasets](https://huggingface.co/docs/huggingface_hub/guides/cli#hf-datasets) [List datasets](https://huggingface.co/docs/huggingface_hub/guides/cli#list-datasets) [Get dataset info](https://huggingface.co/docs/huggingface_hub/guides/cli#get-dataset-info) [List parquet URLs](https://huggingface.co/docs/huggingface_hub/guides/cli#list-parquet-urls) [Run SQL on dataset parquet](https://huggingface.co/docs/huggingface_hub/guides/cli#run-sql-on-dataset-parquet) [hf spaces](https://huggingface.co/docs/huggingface_hub/guides/cli#hf-spaces) [List Spaces](https://huggingface.co/docs/huggingface_hub/guides/cli#list-spaces) [Get Space info](https://huggingface.co/docs/huggingface_hub/guides/cli#get-space-info) [hf papers](https://huggingface.co/docs/huggingface_hub/guides/cli#hf-papers) [List papers](https://huggingface.co/docs/huggingface_hub/guides/cli#list-papers) [Search papers](https://huggingface.co/docs/huggingface_hub/guides/cli#search-papers) [Get paper info](https://huggingface.co/docs/huggingface_hub/guides/cli#get-paper-info) [Read paper as markdown](https://huggingface.co/docs/huggingface_hub/guides/cli#read-paper-as-markdown) [hf discussions](https://huggingface.co/docs/huggingface_hub/guides/cli#hf-discussions) [List discussions](https://huggingface.co/docs/huggingface_hub/guides/cli#list-discussions) [Get info for a discussion or PR](https://huggingface.co/docs/huggingface_hub/guides/cli#get-info-for-a-discussion-or-pr) [Create a discussion or PR](https://huggingface.co/docs/huggingface_hub/guides/cli#create-a-discussion-or-pr) [Comment on a discussion or PR](https://huggingface.co/docs/huggingface_hub/guides/cli#comment-on-a-discussion-or-pr) [Close, reopen, and merge](https://huggingface.co/docs/huggingface_hub/guides/cli#close-reopen-and-merge) [Rename and diff](https://huggingface.co/docs/huggingface_hub/guides/cli#rename-and-diff) [hf repos](https://huggingface.co/docs/huggingface_hub/guides/cli#hf-repos) [Create a repo](https://huggingface.co/docs/huggingface_hub/guides/cli#create-a-repo) [Delete a repo](https://huggingface.co/docs/huggingface_hub/guides/cli#delete-a-repo) [Move a repo](https://huggingface.co/docs/huggingface_hub/guides/cli#move-a-repo) [Update repo settings](https://huggingface.co/docs/huggingface_hub/guides/cli#update-repo-settings) [Delete files from a repo](https://huggingface.co/docs/huggingface_hub/guides/cli#delete-files-from-a-repo) [hf repos branch](https://huggingface.co/docs/huggingface_hub/guides/cli#hf-repos-branch) [hf cache](https://huggingface.co/docs/huggingface_hub/guides/cli#hf-cache) [hf cache ls](https://huggingface.co/docs/huggingface_hub/guides/cli#hf-cache-ls) [hf cache rm](https://huggingface.co/docs/huggingface_hub/guides/cli#hf-cache-rm) [hf cache prune](https://huggingface.co/docs/huggingface_hub/guides/cli#hf-cache-prune) [hf cache verify](https://huggingface.co/docs/huggingface_hub/guides/cli#hf-cache-verify) [hf repos tag](https://huggingface.co/docs/huggingface_hub/guides/cli#hf-repos-tag) [Tag a model](https://huggingface.co/docs/huggingface_hub/guides/cli#tag-a-model) [Tag a model at a specific revision](https://huggingface.co/docs/huggingface_hub/guides/cli#tag-a-model-at-a-specific-revision) [Tag a dataset or a Space](https://huggingface.co/docs/huggingface_hub/guides/cli#tag-a-dataset-or-a-space) [List tags](https://huggingface.co/docs/huggingface_hub/guides/cli#list-tags) [Delete a tag](https://huggingface.co/docs/huggingface_hub/guides/cli#delete-a-tag) [hf env](https://huggingface.co/docs/huggingface_hub/guides/cli#hf-env) [hf jobs](https://huggingface.co/docs/huggingface_hub/guides/cli#hf-jobs) [✨ Key Features](https://huggingface.co/docs/huggingface_hub/guides/cli#-key-features) [Quick Start](https://huggingface.co/docs/huggingface_hub/guides/cli#quick-start) [1\. Run your first job](https://huggingface.co/docs/huggingface_hub/guides/cli#1-run-your-first-job) [2\. Check job status](https://huggingface.co/docs/huggingface_hub/guides/cli#2-check-job-status) [3\. Run on GPU](https://huggingface.co/docs/huggingface_hub/guides/cli#3-run-on-gpu) [Common Use Cases](https://huggingface.co/docs/huggingface_hub/guides/cli#common-use-cases) [Pass Environment variables and Secrets](https://huggingface.co/docs/huggingface_hub/guides/cli#pass-environment-variables-and-secrets) [Built-in Environment Variables](https://huggingface.co/docs/huggingface_hub/guides/cli#built-in-environment-variables) [Job Timeout](https://huggingface.co/docs/huggingface_hub/guides/cli#job-timeout) [Hardware](https://huggingface.co/docs/huggingface_hub/guides/cli#hardware) [Volumes](https://huggingface.co/docs/huggingface_hub/guides/cli#volumes) [Labels](https://huggingface.co/docs/huggingface_hub/guides/cli#labels) [UV Scripts (Experimental)](https://huggingface.co/docs/huggingface_hub/guides/cli#uv-scripts-experimental) [hf jobs scheduled](https://huggingface.co/docs/huggingface_hub/guides/cli#hf-jobs-scheduled) [hf webhooks](https://huggingface.co/docs/huggingface_hub/guides/cli#hf-webhooks) [List webhooks](https://huggingface.co/docs/huggingface_hub/guides/cli#list-webhooks) [Get webhook info](https://huggingface.co/docs/huggingface_hub/guides/cli#get-webhook-info) [Create a webhook](https://huggingface.co/docs/huggingface_hub/guides/cli#create-a-webhook) [Update a webhook](https://huggingface.co/docs/huggingface_hub/guides/cli#update-a-webhook) [Enable / disable a webhook](https://huggingface.co/docs/huggingface_hub/guides/cli#enable--disable-a-webhook) [Delete a webhook](https://huggingface.co/docs/huggingface_hub/guides/cli#delete-a-webhook) [hf endpoints](https://huggingface.co/docs/huggingface_hub/guides/cli#hf-endpoints) [hf endpoints catalog](https://huggingface.co/docs/huggingface_hub/guides/cli#hf-endpoints-catalog)
